            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('admin/assets/img/logo-khz.png')}}" alt="Klorofil Logo"></div>
                                <p class="lead">{{__('login.language')}}</p>
                            </div>
                            <form class="form-auth-small" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="bottom">
                                    ...
                                    <span class="helper-text"><i class="fa fa-lock"></i> <a href="{{ route('password.request') }}">{{__('login.forgot_password')}}</a></span>
                                    @endif
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <!-- <h1 class="heading">Document archive management application</h1> -->
                            <h1 class="heading">{{ __('login.title') }}</h1>
                            <p>{{ __('login.by') }}</p>
                        </div>
                    </div>
